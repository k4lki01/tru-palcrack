...
// const struct FVector2D&                 LeaningVelocity_0                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FPoseLink*                       FlyLeaningOverride_0                                   (Parm, OutParm, NoDestructor)

void UABP_MonsterBase_C::FlyLeaningOverride(const struct FPoseLink& InPose_1, const struct FVector2D& LeaningVelocity_0, struct FPoseLink* FlyLeaningOverride_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.LeaningVelocity_0 = std::move(LeaningVelocity_0);
...
void UABP_MonsterBase_C::SwimLeaningOverride(const struct FPoseLink& InPose_3, const struct FVector2D& LeaningVelocity_0, struct FPoseLink* SwimLeaningOverride_0)
{
	static class UFunction* Func = nullptr;
...
void UABP_MonsterBase_C::WalkLeaningOverride(const struct FPoseLink& InPose_2, const struct FVector2D& LeaningVelocity_0, struct FPoseLink* WalkLeaningOverride_0)
{
	static class UFunction* Func = nullptr;
