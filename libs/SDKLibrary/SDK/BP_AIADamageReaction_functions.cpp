...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FPalDamageRactionInfo&     ReactionInfo                                           (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FPalEachDamageRactionInfo& EachReactionInfo                                       (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
...
// const struct FVector&                   FixPos                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Function BP_AIADamageReaction.BP_AIADamageReaction_C.StartStepCoolTime
// (BlueprintCallable, BlueprintEvent)

void UBP_AIADamageReaction_C::StartStepCoolTime()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIADamageReaction_C", "StartStepCoolTime");
