...
bool UBP_AIAction_CombatPal_C::CheckWazaMaxRange()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_CombatPal_C", "CheckWazaMaxRange");

	Params::BP_AIAction_CombatPal_C_CheckWazaMaxRange Parms{};
...
bool UBP_AIAction_CombatPal_C::CheckWazaMinRange()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_CombatPal_C", "CheckWazaMinRange");

	Params::BP_AIAction_CombatPal_C_CheckWazaMinRange Parms{};
...
// Parameters:
// const struct FPalDamageResult&          DmgResult                                              (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
...
// Parameters:
// bool*                                   OnSea                                                  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_AIAction_CombatPal_C::IsTargetOnSea(bool* OnSea)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_CombatPal_C", "IsTargetOnSea");

	Params::BP_AIAction_CombatPal_C_IsTargetOnSea Parms{};
...
void UBP_AIAction_CombatPal_C::IsTargetOutOfOilrigRange(bool* OutRange)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_CombatPal_C", "IsTargetOutOfOilrigRange");

	Params::BP_AIAction_CombatPal_C_IsTargetOutOfOilrigRange Parms{};
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const class UPalActionComponent*        ActionComponent                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
