...
public:
	...
	TDelegate<void(const struct FPalInstanceID& ID)> K2Node_CreateDelegate_OutputDelegate_1;         // 0x00E8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class APalAIController*                       CallFunc_GetPalAIController_ReturnValue;           // 0x02B8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
