...
void UBP_AIAction_Visitor_WaitInBaseCamp_C::SightCheck(EPalAIResponseType CurrentState, bool OverrideIsDamage, class AActor** Target, EPalAIResponseType* ResponseType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_Visitor_WaitInBaseCamp_C", "SightCheck");

	Params::BP_AIAction_Visitor_WaitInBaseCamp_C_SightCheck Parms{};
