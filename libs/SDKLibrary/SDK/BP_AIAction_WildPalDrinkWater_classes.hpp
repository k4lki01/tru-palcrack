...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_AIAction_WildPalDrinkWater_C;    // 0x0160(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	struct FVector                                GoalPos;                                           // 0x0168(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
