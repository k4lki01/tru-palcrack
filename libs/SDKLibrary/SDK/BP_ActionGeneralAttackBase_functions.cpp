...
void UBP_ActionGeneralAttackBase_C::Shorten_Animation_Time_when_Pal_Ridden()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ActionGeneralAttackBase_C", "Shorten Animation Time when Pal Ridden");
