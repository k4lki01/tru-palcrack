...
void UBP_ActionGeneralAttackFarBase_C::IsEnableRotPitch(bool* IsEnable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ActionGeneralAttackFarBase_C", "IsEnableRotPitch");

	Params::BP_ActionGeneralAttackFarBase_C_IsEnableRotPitch Parms{};
