...
// const struct FTransform&                FootTransform                                          (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBP_AnimNotify_FootStep_C::Create_Footstep_Decal(class AActor* Owner, const struct FTransform& FootTransform) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AnimNotify_FootStep_C", "Create Footstep Decal");

	Params::BP_AnimNotify_FootStep_C_Create_Footstep_Decal Parms{};
...
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent, BlueprintPure, Const)
// Parameters:
// class UPalStaticCharacterParameterComponent*StaticParam                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void UBP_AnimNotify_FootStep_C::Get_Step_Effect_Transform(class UPalStaticCharacterParameterComponent* StaticParam, double* Scale, struct FVector* Offset, class UNiagaraSystem** Effect) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AnimNotify_FootStep_C", "Get Step Effect Transform");

	Params::BP_AnimNotify_FootStep_C_Get_Step_Effect_Transform Parms{};

	Parms.StaticParam = StaticParam;
...
// Parameters:
// class AActor*                           Owner                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// const struct FPalDataTableRowName_SoundID&SoundId                                                (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)
