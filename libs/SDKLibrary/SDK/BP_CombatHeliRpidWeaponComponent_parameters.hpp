...
public:
	...
	class UNiagaraSystem*                         CallFunc_GetMuzzleFlashEffect_Effect;              // 0x0008(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FTransform                             CallFunc_GetMuzzleTransform_MzlTF;                 // 0x0050(0x0060)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FTransform                             CallFunc_GetMuzzleTransform_MzlTF_1;               // 0x0120(0x0060)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class APalBullet*                             CallFunc_FinishSpawningActor_ReturnValue;          // 0x0258(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UProjectileMovementComponent*           CallFunc_GetComponentByClass_ReturnValue;          // 0x0260(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_MakeRotator_Pitch_ImplicitCast;           // 0x026C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
