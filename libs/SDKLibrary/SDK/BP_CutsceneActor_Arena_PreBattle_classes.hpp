...
public:
	...
	class UPalCutsceneArenaPreBattleBindParameter* PreBattleBindParameter;                           // 0x0328(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
