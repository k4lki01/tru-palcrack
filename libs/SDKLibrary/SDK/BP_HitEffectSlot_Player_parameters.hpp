...
public:
	...
	struct FPalDamageInfo                         K2Node_Event_info;                                 // 0x0038(0x0128)(ConstParm)
	TSoftObjectPtr<class UNiagaraSystem>          K2Node_CustomEvent_EffectPath;                     // 0x0160(0x0030)(HasGetValueTypeHash)
	struct FTransform                             K2Node_CustomEvent_Transform;                      // 0x0190(0x0060)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class APalCharacter*                          CallFunc_FindOwnerPalCharacter_ReturnValue;        // 0x0240(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalSkeletalMeshComponent*              CallFunc_GetMainMesh_ReturnValue;                  // 0x0248(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
