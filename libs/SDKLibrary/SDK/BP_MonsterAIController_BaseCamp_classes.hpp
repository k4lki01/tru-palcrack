...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_MonsterAIController_BaseCamp_C;  // 0x0560(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	struct FVector                                SpawnedPosition;                                   // 0x0568(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
