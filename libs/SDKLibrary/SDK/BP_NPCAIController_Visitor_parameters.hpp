...
public:
	...
	struct FPalVisitorInitParameter               K2Node_Event_InitParam;                            // 0x0050(0x0040)(ConstParm, NoDestructor)
	class APawn*                                  K2Node_Event_PossessedPawn;                        // 0x0090(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalRecruiterComponent*                 CallFunc_GetComponentByClass_ReturnValue;          // 0x0098(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UPalNPCInteractionComponent*            CallFunc_GetComponentByClass_ReturnValue_1;        // 0x00C0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
