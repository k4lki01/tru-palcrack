...
public:
	...
	class UBP_HumanCryComponent_C*                BP_HumanCryComponent;                              // 0x0AA0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
