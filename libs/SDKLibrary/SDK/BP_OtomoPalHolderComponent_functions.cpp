...
// Parameters:
// const struct FTransform&                ballTransform                                          (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBP_OtomoPalHolderComponent_C::ActivateCurrentOtomoFromBallNative(const struct FTransform& ballTransform, class AActor* hitTarget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_OtomoPalHolderComponent_C", "ActivateCurrentOtomoFromBallNative");

	Params::BP_OtomoPalHolderComponent_C_ActivateCurrentOtomoFromBallNative Parms{};
...
// (Event, Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const class UPalIndividualCharacterHandle*OtomoHandle                                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// bool                                    bKeepActigvateOtomoId                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_OtomoPalHolderComponent_C::ActivatePalByHandle(const class UPalIndividualCharacterHandle* OtomoHandle, const struct FVector& Location, const struct FRotator& Rotation, bool bKeepActigvateOtomoId)
{
	static class UFunction* Func = nullptr;
	...
	Parms.OtomoHandle = OtomoHandle;
	Parms.Location = std::move(Location);
	Parms.Rotation = std::move(Rotation);
	Parms.bKeepActigvateOtomoId = bKeepActigvateOtomoId;
...
// Parameters:
// const struct FPalDeadInfo&              Actor                                                  (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
...
void UBP_OtomoPalHolderComponent_C::DIsplayOtomoDeathLog(const struct FPalDeadInfo& DeadInfo)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_OtomoPalHolderComponent_C", "DIsplayOtomoDeathLog");

	Params::BP_OtomoPalHolderComponent_C_DIsplayOtomoDeathLog Parms{};
...
void UBP_OtomoPalHolderComponent_C::GetAIClass(class UClass** Class_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_OtomoPalHolderComponent_C", "GetAIClass");

	Params::BP_OtomoPalHolderComponent_C_GetAIClass Parms{};
...
// const struct FTransform&                TF                                                     (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
