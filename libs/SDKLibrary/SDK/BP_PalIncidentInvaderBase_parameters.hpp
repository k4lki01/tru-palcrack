...
public:
	...
	struct FPalIndividualCharacterSaveParameter   CallFunc_GetInitializedCharacterSaveParemter_outParameter; // 0x00B8(0x0338)()
	...
	class APlayerController*                      CallFunc_GetLocalPlayerController_ReturnValue;     // 0x0400(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FNetworkActorSpawnParameters           K2Node_MakeStruct_NetworkActorSpawnParameters;     // 0x0408(0x0078)(NoDestructor)
	class UPalIndividualCharacterHandle*          CallFunc_SpawnNewCharacter_ReturnValue;            // 0x0480(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
