...
{
public:
	struct FPalIncidentBroadcastParameter         Parameter;                                         // 0x0000(0x00B0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
...
public:
	...
	struct FPalIncidentBroadcastParameter         K2Node_Event_Parameter;                            // 0x0008(0x00B0)(ConstParm)
	TDelegate<void(class UPalIncidentNotifyListener* Listener, EPalIncidentState IncidentState, const struct FPalIncidentNotifyParameter& Parameter)> K2Node_CreateDelegate_OutputDelegate; // 0x00B8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalIncidentNotifyListener*             K2Node_CustomEvent_Listener;                       // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	EPalIncidentState                             K2Node_CustomEvent_IncidentState;                  // 0x00E8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_E9[0x7];                                       // 0x00E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalIncidentNotifyParameter            K2Node_CustomEvent_Parameter;                      // 0x00F0(0x0028)(ConstParm, NoDestructor)
	...
	class UBP_PalIncidentNotifyListener_C*        CallFunc_SpawnObject_ReturnValue;                  // 0x0120(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
