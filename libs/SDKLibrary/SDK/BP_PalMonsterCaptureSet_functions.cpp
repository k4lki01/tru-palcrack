...
void ABP_PalMonsterCaptureSet_C::ReceiveEndPlay(EEndPlayReason EndPlayReason)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PalMonsterCaptureSet_C", "ReceiveEndPlay");

	Params::BP_PalMonsterCaptureSet_C_ReceiveEndPlay Parms{};
