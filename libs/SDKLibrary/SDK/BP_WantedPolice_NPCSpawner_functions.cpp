...
void ABP_WantedPolice_NPCSpawner_C::CheckWanted()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_WantedPolice_NPCSpawner_C", "CheckWanted");
...
void ABP_WantedPolice_NPCSpawner_C::FinderChangeAction(class APalCharacter* Reporter, class APalCharacter* WantedPlayer, EPalOrganizationType Organization)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_WantedPolice_NPCSpawner_C", "FinderChangeAction");

	Params::BP_WantedPolice_NPCSpawner_C_FinderChangeAction Parms{};
...
bool ABP_WantedPolice_NPCSpawner_C::GetBoxOverlappingActors(class UClass* ActorClassFilter, TArray<class AActor*>* OutActors)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_WantedPolice_NPCSpawner_C", "GetBoxOverlappingActors");

	Params::BP_WantedPolice_NPCSpawner_C_GetBoxOverlappingActors Parms{};
...
// Parameters:
// class UPalIndividualCharacterHandle*    CriminalHandle                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// const struct FPalWorldSecurityWantedStateInfo&WantedStateInfo                                        (BlueprintVisible, BlueprintReadOnly, Parm)
