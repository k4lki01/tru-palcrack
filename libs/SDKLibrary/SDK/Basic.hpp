...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08EB6280;
	constexpr int32 AppendString      = 0x0316E380;
	constexpr int32 GNames            = 0x08DBB7F8;
	constexpr int32 GWorld            = 0x09024A38;
	constexpr int32 ProcessEvent      = 0x032ECEB0;
