...
public:
	...
	TMulticastInlineDelegate<void(const struct FLinearColor& Color)> OnSelectedEyeColor;             // 0x04C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(const struct FLinearColor& Color)> OnSelectedBrowColor;            // 0x04D8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
