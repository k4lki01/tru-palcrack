...
public:
	...
	TMulticastInlineDelegate<void(const struct FLinearColor& HSV)> OnSelectedHairColor;              // 0x04A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
