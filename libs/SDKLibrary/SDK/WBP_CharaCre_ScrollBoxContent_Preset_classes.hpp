...
public:
	...
	TMulticastInlineDelegate<void(class FName PresetName)> OnSelectedPreset;                         // 0x0438(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
