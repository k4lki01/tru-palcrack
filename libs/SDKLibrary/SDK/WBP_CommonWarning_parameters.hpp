...
public:
	...
	TSoftObjectPtr<class UTexture2D>              K2Node_Select_Default;                             // 0x00B0(0x0030)(UObjectWrapper, HasGetValueTypeHash)
	struct FPalUICommonWarningDisplayData         K2Node_CustomEvent_WarningData;                    // 0x00E0(0x0030)()
