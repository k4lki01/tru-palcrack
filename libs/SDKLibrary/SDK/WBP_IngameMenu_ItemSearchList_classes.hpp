...
public:
	...
	TMulticastInlineDelegate<void(class UWBP_PalItemSlotButtonBase_C* Slot, EPalItemSlotPressType PressType)> OnRightClickSlot; // 0x0498(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void()>              OnSlotHovered;                                     // 0x04D8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	bool                                          bCanSearchByItemId;                                // 0x0539(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
