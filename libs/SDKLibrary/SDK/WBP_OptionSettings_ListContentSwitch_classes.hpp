...
public:
	...
	TMulticastInlineDelegate<void(bool IsOn)>     OnSwitcherChanged;                                 // 0x02B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
