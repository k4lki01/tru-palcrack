...
public:
	...
	TMulticastInlineDelegate<void(class FName KeyName, ECommonInputType InputType, EPalKeyConfigAxisFilterType AxisType)> OnKeyConfigClicked; // 0x04F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("WBP_OptionSettings_ListContent_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"WBP_OptionSettings_ListContent_C")
	}
...
DUMPER7_ASSERTS_UWBP_OptionSettings_ListContent_C;
