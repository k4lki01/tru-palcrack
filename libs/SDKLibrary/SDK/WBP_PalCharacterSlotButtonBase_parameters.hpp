...
public:
	...
	TDelegate<void(class UPalIndividualCharacterSlot* TargetSlot)> K2Node_CreateDelegate_OutputDelegate_4; // 0x0044(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
