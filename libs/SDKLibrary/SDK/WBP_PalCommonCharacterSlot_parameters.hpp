...
public:
	...
	TDelegate<void(class UPalIndividualCharacterSlot* TargetSlot)> K2Node_CreateDelegate_OutputDelegate; // 0x0038(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(int64 nowHP, int64 nowMaxHP)>  K2Node_CreateDelegate_OutputDelegate_3;            // 0x0068(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(double NowTimer)>              K2Node_CreateDelegate_OutputDelegate_11;           // 0x00E8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_WBP_PalCommonCharacterSlot_C_OnUpdateHP_Binded;
...
public:
	...
	float                                         CallFunc_GetPalEnhancementStatusRate_Attack_ReturnValue; // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
