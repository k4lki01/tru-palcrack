...
public:
	...
	TSoftClassPtr<class UClass>                   CallFunc_GetNoWeaponIdleAnimationByCharacterMakeInfo_ReturnValue; // 0x0208(0x0030)(UObjectWrapper, HasGetValueTypeHash)
	class UClass*                                 CallFunc_LoadClassAsset_Blocking_ReturnValue;      // 0x0238(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalShooterAnimeAssetBase*              CallFunc_Map_Find_Value;                           // 0x0240(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UObject*                                CallFunc_SpawnObject_ReturnValue;                  // 0x0250(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalShooterAnimeAssetBase*              K2Node_DynamicCast_AsPal_Shooter_Anime_Asset_Base; // 0x0258(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
