...
public:
	...
	TMulticastInlineDelegate<void(class UWBP_PalStorageSortTypeButton_C* Widget)> OnClicked;         // 0x02C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
