...
public:
	...
	TMulticastInlineDelegate<void(int32 OldIndex, int32 NewIndex, class UWidget* FocusTargetWidget)> OnChangedFocusIndex; // 0x0418(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(int32 OldIndex, int32 NewIndex)> OnNext;                           // 0x0428(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(int32 OldIndex, int32 NewIndex)> OnPrev;                           // 0x0438(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(int32 Index, class UWidget* ChildWidget, bool IsEnable)> OnChangeEnableChild; // 0x0450(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
