...
void UWBP_TitleMenu_C::カスタムイベント(bool bResult)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_TitleMenu_C", "カスタムイベント");

	Params::WBP_TitleMenu_C_カスタムイベント Parms{};
...
// Function WBP_TitleMenu.WBP_TitleMenu_C.OnCheckedJoinServerCertification
// (BlueprintCallable, BlueprintEvent)

void UWBP_TitleMenu_C::OnCheckedJoinServerCertification()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_TitleMenu_C", "OnCheckedJoinServerCertification");
