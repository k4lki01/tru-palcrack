...
public:
	...
	TMulticastInlineDelegate<void()>              OnClickedCloseButton;                              // 0x0430(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
