...
void UWBP_Title_DeleteWorldWindow_C::BndEvt__WBP_Title_DeleteWorldWindow_PalEditableTextBox_144_K2Node_ComponentBoundEvent_5_OnEditableTextBoxCommittedEvent__DelegateSignature(const class FText& Text, ETextCommit CommitMethod)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Title_DeleteWorldWindow_C", "BndEvt__WBP_Title_DeleteWorldWindow_PalEditableTextBox_144_K2Node_ComponentBoundEvent_5_OnEditableTextBoxCommittedEvent__DelegateSignature");

	Params::WBP_Title_DeleteWorldWindow_C_BndEvt__WBP_Title_DeleteWorldWindow_PalEditableTextBox_144_K2Node_ComponentBoundEvent_5_OnEditableTextBoxCommittedEvent__DelegateSignature Parms{};
...
void UWBP_Title_DeleteWorldWindow_C::BndEvt__WBP_Title_DeleteWorldWindow_PalEditableTextBox_144_K2Node_ComponentBoundEvent_4_OnEditableTextBoxChangedEvent__DelegateSignature(const class FText& Text)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Title_DeleteWorldWindow_C", "BndEvt__WBP_Title_DeleteWorldWindow_PalEditableTextBox_144_K2Node_ComponentBoundEvent_4_OnEditableTextBoxChangedEvent__DelegateSignature");

	Params::WBP_Title_DeleteWorldWindow_C_BndEvt__WBP_Title_DeleteWorldWindow_PalEditableTextBox_144_K2Node_ComponentBoundEvent_4_OnEditableTextBoxChangedEvent__DelegateSignature Parms{};
